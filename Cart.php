    ...
    <div id="wrapper">
        ...
        <div id="content">
            ...
            <table width="100%" border="1" bordercolor="#003300" >
                ...
                $sql = "SELECT shopping_cart.CartId, shopping_cart.ItemName, shopping_cart.Quantity, shopping_cart.Total, item.`Size`, item.Image
                        FROM admin, shopping_cart, item
                        WHERE item.ItemName=shopping_cart.ItemName and shopping_cart.CustomerId=".$_SESSION['ID']."";
