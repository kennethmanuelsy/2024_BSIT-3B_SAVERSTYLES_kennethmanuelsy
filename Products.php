...
$query_Recordset1 = sprintf("SELECT ItemName, `Description`, `Size`, Image, Price, Discount, Total FROM item WHERE CategoryId = %s", GetSQLValueString($colname_Recordset1, "int"));
