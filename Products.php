...
$query_Recordset1 = "SELECT CategoryId, CategoryName FROM category";
...
$query_Recordset2 = sprintf("SELECT ItemId, ItemName, `Size`, Image, Price, Discount, Total FROM item WHERE CategoryId = %s", GetSQLValueString($colname_Recordset2, "int"));
